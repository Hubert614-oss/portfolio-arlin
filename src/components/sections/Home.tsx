...
const Home = () => {
    ...
    const AnimatedCounter = ({ value, suffix, label, delay }: AnimatedCounterProps) => {
        ...
        return (
            ...
            >
                <p className="text-4xl md:text-5xl font-bold bg-linear-to-r from-slate-900 via-cyan-300 to-cyan-400 bg-clip-text text-transparent dark:from-white dark:via-cyan-300 dark:to-cyan-400">
                    {count}{suffix}
                </p>
                <p className="text-sm md:text-base text-slate-300 mt-2 font-medium dark:text-slate-300">{label}</p>
            </motion.div>
        )
    }
            ...
            <AnimatedBackground variant={theme} showGrid showOrbs showDots>
                <div className="relative z-20 pt-24 pb-20 md:pt-20 md:pb-32">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 text-nowrap text-white">
                                        <span className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/10 backdrop-blur-sm rounded-full border border-cyan-400 text-sm font-medium text-cyan-300 dark:text-cyan-300">
                            ...
                            >
                                ...
                                <motion.p
                                    ...
                                    className="mb-2 text-2xl md:text-2xl text-cyan-300 font-bold dark:text-cyan-400"
                                >
                                    Bonjour!👋
                                </motion.p>
                                ...
                                <motion.p
                                    variants={itemVariants}
                                    className="text-lg md:text-xl text-cyan-300 font-medium dark:text-cyan-400"
                                >
                                    C'est
                                </motion.p>
                                ...
                                <motion.p
                                    variants={itemVariants}
                                    className="text-xl md:text-2xl font-semibold mb-2 sm:mb-8 text-slate-300 leading-relaxed dark:text-slate-200"
                                >
                                    Créer des{' '}
                                    <motion.span
                                        className="text-cyan-300 inline-block dark:text-cyan-400"
                                ...
                                <motion.p
                                    variants={itemVariants}
                                    className="text-base md:text-lg text-slate-300 mb-4 sm:mb-10 max-w-lg leading-relaxed dark:text-slate-300"
                                >
                                ...
                                >
                                    ...
                                    <Link to="/contact"
                                        className="group px-6 py-3.5 text-sm font-bold bg-transparent border border-slate-300/70 text-slate-300 rounded-xl hover:bg-slate-200/10 hover:border-slate-400 transition-all duration-300 backdrop-blur-sm text-center sm:px-8 sm:py-4 sm:text-base dark:border-white/20 dark:text-white dark:hover:bg-white/5 dark:hover:border-white/30"
                                    >
                                    ...
                                    <a
                                        ...
                                        className="group inline-flex items-center justify-center gap-3 rounded-xl border border-cyan-500/10 bg-cyan-500/10 px-3 py-2.5 text-xs font-bold text-cyan-300 transition-all duration-300 hover:border-cyan-600 hover:bg-cyan-500/20 hover:text-cyan-500 sm:text-sm sm:px-4 sm:py-3 dark:border-cyan-400/30 dark:bg-cyan-500/10 dark:text-cyan-300 dark:hover:border-cyan-300 dark:hover:bg-cyan-500/20 dark:hover:text-white"
                                    >
                                        <img
                                            src={cvPreview}
                                            alt="Aperçu du CV"
                                            className="h-8 w-8 rounded-full object-cover border border-cyan-300/60 shadow-lg shadow-cyan-500/20 sm:h-10 sm:w-10"
                                        />
                                        <span>Mon CV</span>
                                        <motion.span
                                            animate={{ y: [0, 2, 0] }}
                        ...
                        >
                            <div className="relative bg-white/6 rounded-3xl p-8 md:p-12 shadow-sm ring-1 ring-slate-200/60 dark:bg-slate-900/60 dark:ring-white/10">
