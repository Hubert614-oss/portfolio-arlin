                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 text-nowrap">
                                        <span className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-200/10 backdrop-blur-sm rounded-full border border-cyan-700 text-sm font-medium text-cyan-700 dark:bg-cyan-500/10 dark:border-cyan-400/30 dark:text-cyan-300">
                                            <span className="w-2 h-2 bg-cyan-700 rounded-full animate-pulse dark:bg-cyan-300" />
