    ...
    return (
        ...
        >
            ...
            <div className="relative mx-auto max-w-6xl">
                ...
                {/* ================= HEADER ================= */}
                <div className="mx-auto mb-20 max-w-3xl text-center md:text-left">
                    ...
                    <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-400">
                        Un parcours construit autour du développement web,
                        du développement Full Stack et de la conception de
                ...
                <div className="relative">
                    ...
                    <div className="absolute left-5 top-0 hidden h-full w-px bg-gradient-to-b from-cyan-400 via-slate-700 to-transparent md:left-1/2 md:block" />

                    {/* Timeline line mobile */}
                    <div className="absolute left-5 top-0 h-full w-px bg-gradient-to-b from-cyan-400 via-slate-700 to-transparent md:hidden" />
                        ...
                        {experiences.map((item, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* ================= DOT ================= */}
                                    <div className="absolute left-[13px] top-8 z-10 md:left-1/2 md:-translate-x-1/2">
                                        <div
                                            className={`flex h-4 w-4 items-center justify-center rounded-full border-4 border-slate-950 ${
                                                item.current
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* Card glow */}
                                            <div className="pointer-events-none absolute -right-20 -top-20 h-40 w-40 rounded-full bg-cyan-400/5 blur-3xl transition-all duration-500 group-hover:bg-cyan-400/10" />
                                            ...
                                            <div className="relative">
                                                ...
                                                <div className="mb-4 flex flex-wrap items-center gap-3">
                                                    ...
                                                    <span className="inline-flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-500/10 px-3 py-1.5 text-xs font-medium text-cyan-300">
                ...
                <div className="mt-16 text-center">
                    ...
                    <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-900/60 px-5 py-2.5 text-sm text-slate-400 backdrop-blur">
                        ...
                        Toujours en apprentissage et à la recherche de
                        nouveaux défis
                    </div>
